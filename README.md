...
All of these logic files are written in Python. To create your own logic files, you can simply create a new folder in \Rules\ named whatever you like, and stash your logic rules in that folder.
